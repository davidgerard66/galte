...
use Gites\GitesBundle\Form\ProduitsType;
...
class ProduitsAdminController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('GitesBundle:Produits')->findAll();

        return $this->render('GitesBundle:Administration:Produits/layout/index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('GitesBundle:Administration:Produits/layout/new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('GitesBundle:Produits')->find($id);
        ...
        return $this->render('GitesBundle:Administration:Produits/layout/show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('GitesBundle:Administration:Produits/layout/edit.html.twig', array(
            'entity'      => $entity,
